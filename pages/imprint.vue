<template>
  <div style="margin: 8em;">
    ...
    <h2 align="center"><strong>Informationen und Offenlegung gemäß &sect;5 (1) ECG, &sect; 25 MedienG, &sect; 63 GewO und &sect; 14 UGB</strong></h2>

    <p>
        <b>Webseitenbetreiber:</b> Daniel Peinhopf<br>
        <!-- <b>Telefonnummer:</b><br> -->
        <b>Email:</b> contact@danielpeinhopf.com
    </p>
    ...
    <p style="font-size: 8pt;">
        Quelle: <b><a href="https://ghostweb.agency/impressum-generator-oesterreich/">Impressum Generator</a></b>
    </p>
  </div>
</template>
